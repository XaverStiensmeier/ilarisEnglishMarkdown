...
### Open Checks
Most tests are open checks, where the game master determines the difficulty of the test. Experienced game masters can do this intuitively, but until then, you can refer to the following table.
